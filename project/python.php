...
<head>
    ...
    <script>
        var index = 0;
        var score = 0;
        var question = ["What is the primary purpose of a for loop in Python?", "What does the term PEP 8 refer to in Python programming?","Explain the concept of list comprehension in Python.",
            "What is the difference between a function and a method in Python?", "How do you declare a single-line comment in Python?"];
var option1 = ["To execute code only once", " Python Execution Protocol version 8", " It refers to creating a list with a loop and condition in a single line of code", "There is no difference, they are synonyms ", "// This is a comment "];
        var option2 = ["To perform operations on arrays", " Python Enhancement Proposal 8, which provides style guidelines for Python code", " It represents a way to define functions with a lambda keyword", "A function is defined outside a class, while a method is defined inside a class ", " /* This is a comment */"];
        var option3 = ["To iterate over a sequence of elements and execute a block of code for each element", "Python Expression Parser version 8", " It defines the size of memory allocated for variables", "A function is used for mathematical calculations, while a method is used for data manipulation", "<!-- This is a comment -->"];
        var option4 = ["To define a function", "Python Environment Package version 8", "It determines the visibility and accessibility of variables and methods within a program", "A function can only return values, while a method can perform actions and return values ", "# This is a comment"];
        var answer = [3,2,1,2,4];
