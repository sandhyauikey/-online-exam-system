...
<head>
    ...
    <script>
        var index = 0;
        var score = 0;
        var question = ["What is the primary purpose of a while loop in Java?", "What does the term JVM stand for in Java programming?","What does the term polymorphism mean in Java?",
            "Explain the concept of inheritance in Java.", "How do you declare a single-line comment in Java?"];
        var option1 = ["To execute code only once", "Java Virtual Machine", "It refers to the process of converting a primitive type into an object", " It refers to the process of creating multiple instances of an object ", " // This is a comment "];
        var option2 = ["To perform operations on arrays", "Just Very Mighty", "It allows a method to perform different actions based on the object it is called on", " It enables a class to inherit properties and methods from another class ", "/* This is a comment */"];
        var option3 = ["To execute a block of code repeatedly as long as a condition is true", "Java Validation Model", "It defines a relationship between classes where one class inherits from another", "It defines the size of memory allocated for variables", " <!-- This is a comment -->"];
        var option4 = ["To define a function", "Java Virtual Method", "It ensures that a class can only be instantiated once", " It determines the visibility and accessibility of variables and methods within a program ", "# This is a comment"];
        var answer = [3, 1, 2, 2, 1];
