...
<head>
    ...
    <script>
        var index = 0;
        var score = 0;
        var question = ["Which of the following is not a valid variable name in C?", "What does the sizeof operator return in C?", "In C, which operator is used to access the address of a variable?",
            "What is the purpose of the break statement in C?", "Which of the following is not a fundamental data type in C?"];
        var option1 = ["myVar", "Memory address", "&", "Terminate the program", "int"];
        var option2 = ["_number", "Value of a variable", "*", "Exit from a loop or switch case", "float"];
        var option3 = ["123abc", "Size in bytes of a data type", "!", "Skip to the next iteration in a loop", "double"];
        var option4 = ["total_count", "ASCII value", "#", "Print a message", "string"];
        var answer = [3, 3, 1, 2, 4];
