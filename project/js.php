...
<head>
    ...
    <script>
        var index = 0;
        var score = 0;
        var question = ["What is the purpose of the JavaScript querySelector method?", "What does the JavaScript addEventListener method do?","Explain the concept of variable scope in JavaScript.",
            "What is the purpose of the JavaScript setTimeout function?", "How do you declare a variable in JavaScript?"];
var option1 = ["To select and manipulate HTML elements by their class name", "Adds a new event listener to an HTML element", "It refers to the visibility and accessibility of variables within a function or block of code ", "To execute a function repeatedly at specified intervals ", "Using the var keyword "];
        var option2 = [" To select and manipulate HTML elements by their ID", " Adds a new method to an object", "It determines the font style of text on a webpage", "To delay the execution of a function for a specified amount of time", "Using the let keyword"];
        var option3 = ["To select and manipulate HTML elements using CSS selectors", ") Adds a new property to an object", " It represents a way to define functions with a lambda keyword", "To add styles to HTML elements", "Using the const keyword"];
        var option4 = ["To select and manipulate HTML elements by their tag name", "Adds a new function to the global scope", " It defines the size of memory allocated for variables", "To create animations on a webpage", "All of the above"];
        var answer = [3,1,1,2,4];
